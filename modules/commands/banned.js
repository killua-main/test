    ...
    case "-t":
      {
        ...
        return api.sendMessage(listbanViews.length != 0 ? api.sendMessage(`[BAN] 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐠𝐨̂̀𝐦 𝐜𝐨́ ${listbanViews.length} 𝐧𝐡𝐨́𝐦 𝐛𝐢̣ 𝐛𝐚𝐧\n\n${listbanViews.join("\n\n")}` +
    ...
    case "-u":
      {
        ...
        return api.sendMessage(listbanViews.length != 0 ? api.sendMessage(`[BAN] 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐠𝐨̂̀𝐦 𝐜𝐨́ ${listbanViews.length} 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴 𝗯𝗶̣ 𝗯𝗮𝗻\n${listbanViews.join("\n")}` +
          "\n[❇]𝐑𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 + 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣, 𝐜𝐨́ 𝐭𝐡𝐞̂̉ 𝐫𝐞𝐩 𝐧𝐡𝐢𝐞̂̀𝐮 𝐬𝐨̂́, 𝐜𝐚́𝐜𝐡 𝐧𝐡𝐚𝐮 𝐛𝐚̆̀𝐧𝐠 𝐝𝐚̂́𝐮 𝐜𝐚́𝐜𝐡 𝐧𝐞̂́𝐮 𝐦𝐮𝐨̂́𝐧 𝐮𝐧𝐛𝐚𝐧 𝐭𝐡𝐫𝐞𝐚𝐝 𝐭𝐮̛𝐨̛𝐧𝐠 𝐮̛́𝐧𝐠",
          threadID, (error, info) => {
